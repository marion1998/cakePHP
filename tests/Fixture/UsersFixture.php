...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'group_id' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-29 11:36:46',
                'modified' => '2018-08-29 11:36:46'
            ],
        ];
        parent::init();
    }
